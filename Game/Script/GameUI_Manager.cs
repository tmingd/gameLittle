...
public class GameUI_Manager : MonoBehaviour
{
    ...
    public void Start()
    {
        SwithUIState(GameUI_State.GamePlay);
    }
    ...
    private void SwithUIState(GameUI_State state)
    {
    ...
    public void TogglePauseUI()
    {
        ...
        {
            SwithUIState(GameUI_State.Pause);
    ...
    {
        SwithUIState(GameUI_State.GameOver);
    }

    public void ShowGameIsFinishedUI()
    {
        SwithUIState(GameUI_State.GameIsFinished);
    }
}
